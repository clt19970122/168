...
<!--<link rel="stylesheet" href="../../../../../xamppfiles/htdocs/yagebu/Public/home/css/app.css">-->
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Index/learn_infos','id='.$v['id']);?>" class="index-learn_item">
            <div class="box">
                <label class="quns">问</label>
                <div class="content quns"><?php echo ($v["title"]); ?></div>
            </div>
            <div class="box">
                <label class="answ">答</label>
                <div class="content answ"><?php echo ($v["descs"]); ?></div>
            </div>
        </a><?php endforeach; endif; else: echo "" ;endif; ?>

</div-->
<div class="weui-search-bar" id="searchBar">
    <form action="<?php echo U('Index/learn','type='.$get['type']);?>" class="weui-search-bar__form" method="get">
        <div class="weui-search-bar__box">
            <i class="weui-icon-search"></i>
            <input type="search" name="keys" class="weui-search-bar__input" placeholder="输入关键字">
        </div>
    </form>
</div>
...
<div class="index-learn_type">
    <ul>
        <?php if(is_array($cat)): $i = 0; $__LIST__ = $cat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                <a href="<?php echo U('Index/learn','type='.$v['id']);?>" class="weui-btn <?php if($v[id] == $get[type]): ?>active<?php endif; ?>"><?php echo ($v["name"]); ?></a>
...
<div class="index-learn">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Index/learn_infos','id='.$v['id']);?>" class="index-learn_item">
            <div class="box">
                <label class="quns">
                    <img src="/Public/home/imgs/index_learn.png"/>
                </label>
                <div class="content quns"><?php echo ($v["title"]); ?></div>
            </div>
            <div class="box">
