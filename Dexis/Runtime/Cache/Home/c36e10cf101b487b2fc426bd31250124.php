...
<script>
    ...
    function doOption() {
        ...
        showPreLoading();
        $.ajax({
            url: "<?php echo U('Login/doSetName');?>", type: 'post',
            data: data, dataType: "json",
            success: function (res) {
                hidePreLoading();
                if (res.status !== 1) {
