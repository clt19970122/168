...
<!--<link rel="stylesheet" href="../../../../../xamppfiles/htdocs/yagebu/Public/home/css/app.css">-->
    ...
    <body>
        <div class="page">
            ...
            <div class="content">
                <div class="index-learn" style="padding-top:0rem;">

    <div class="index-learn_item">
        <div class="box">
            <label class="quns">问</label>
            <div class="content quns"><?php echo ($info["title"]); ?></div>
        </div>
        <div class="box">
            <label class="answ">答</label>
            <div class="content answ"><?php echo ($info["content"]); ?></div>
        </div>
    </div>
