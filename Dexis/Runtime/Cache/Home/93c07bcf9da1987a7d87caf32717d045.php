...
<!--<link rel="stylesheet" href="../../../../../xamppfiles/htdocs/yagebu/Public/home/css/app.css">-->
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="home-item">
    ...
    <!--<div class="" style="width: 100%;text-align: left;font-size: 24px;background: #fff;font-weight: 500;color: #000;padding-top: 15px;padding-left: 1rem">周边产品</div>-->
    <div class="mall-title"></div>
    <div style="display: flex">
        <!--<?php if(is_array($datap)): $i = 0; $__LIST__ = $datap;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="home-item">
                <a href="<?php echo U('Malls/goods','sn='.$v['gsn']);?>" class="home-item_thumb">
                    <img style="border-radius: .5rem" src="/Public/uploads/goods/<?php echo (getGoodsImg($v['gsn'],$img)); ?>"/>
                </a>
                <div class="home-item_cont">
                    <div class="home-item_cont_title" style="font-size: 1.4rem;height: 3.6rem"><i class="order-list-name-icon green">New</i><?php echo ($v["name"]); ?></div>
                    <div class="home-item_cont_descs"><?php echo ($v["subname"]); ?>
                    <div class="home-item_cont_price">
                        <span><font>￥</font><?php echo ($v["price"]); ?><font>元</font></span>
                        <a class="blue" href="<?php echo U('Malls/goods','sn='.$v['gsn']);?>">立即购买</a>
                    </div>
                </div>
            </div><?php endforeach; endif; else: echo "" ;endif; ?>-->
    ...
    <div style="display: flex">
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="home-item">
                <a href="<?php echo U('Malls/goods','sn='.$v['gsn']);?>" class="home-item_thumb">
                    <img style="border-radius: .5rem" src="/Public/uploads/goods/<?php echo (getGoodsImg($v['gsn'],$img)); ?>"/>
                </a>
                <div class="home-item_cont">
                    ...
                    <!--<div class="home-item_cont_descs"><?php echo ($v["subname"]); ?></div>-->
                    <div class="home-item_cont_price">
                        <span><font>￥</font><?php echo ($v["price"]); ?><font></font></span>
                        <a class="blue" href="<?php echo U('Malls/goods','sn='.$v['gsn']);?>">立即购买</a>
                    </div>
                </div>
            </div><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <!--<div class="home-item">
            ...
            <div class="home-item_cont">
                <div class="home-item_cont_title" style="font-size: 1.4rem;height: 3.6rem"><?php echo ($v["name"]); ?></div>
                &lt;!&ndash;<div class="home-item_cont_descs"><?php echo ($v["subname"]); ?></div>&ndash;&gt;
                <div class="home-item_cont_price">
                    <span><font>￥</font><?php echo ($v["price"]); ?></span>
                    <a class="blue" href="<?php echo U('Malls/goods','sn='.$v['gsn']);?>">立即购买</a>
                </div>
