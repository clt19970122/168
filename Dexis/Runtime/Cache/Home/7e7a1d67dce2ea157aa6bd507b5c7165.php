...
<!--<link rel="stylesheet" href="../../../../../xamppfiles/htdocs/yagebu/Public/home/css/app.css">-->
    ...
    <body>
        <div class="page">
            ...
            <div class="content">
                <div class="index-money_item" id="d">
    <div class="index-money_item-box">
        <div class="item"><b>下单用户</b></div>
        <div class="item"><b>下单时间</b></div>
        <!--<div class="item"><?php echo (date('H:i:s',$v["times"])); ?></div>-->
        <div class="item"><b>数量</b></div>
        <div class="item"><b>剩余</b></div>
        <div class="item"><b>进出</b></div>
    </div>
    <?php if(is_array($nums)): $i = 0; $__LIST__ = $nums;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="index-money_item-box">
            <div class="item"><span><?php echo ($v["lowuser"]); ?></span></div>
            <div class="item"><span><?php echo ($v["time"]); ?></span></div>
            <div class="item"><span><?php echo ($v["nums"]); ?></span></div>
            <div class="item"><span><?php echo ($v["show_rest"]); ?></span></div>
            <div class="item"><span><?php echo ($v["type"]); ?></span></div>
