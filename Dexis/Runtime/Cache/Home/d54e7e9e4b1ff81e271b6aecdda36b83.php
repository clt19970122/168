...
<!--<link rel="stylesheet" href="../../../../../xamppfiles/htdocs/yagebu/Public/home/css/app.css">-->
    ...
    <body>
        ...
        <div class="weui-panel__bd">
            <a href="javascript:;" class="weui-media-box weui-media-box_appmsg" style="padding-bottom: 0">
                <div class="weui-media-box__hd">
                    <img class="weui-media-box__thumb" src="/Public/uploads/goods/<?php echo ($v["gimgs"]); ?>"/>
                </div>
                <div class="weui-media-box__bd">
                    <h4 class="weui-media-box__title"><?php echo ($v["gname"]); ?></h4>
                    <p class="weui-media-box__desc">订单编号:<?php echo ($v["sn"]); ?><br/>申请日期:<?php echo (date('Y年m月d日 H:i:s',$v["times"])); ?> </p>
                    <p class="weui-media-box__price">
                        ¥<?php echo ($v["money"]); ?><font>元</font>
                    </p>
                  ...
                  <div style="padding: 0 1rem;">
                        <p class="weui-media-box__price">
                        <?php if(($v["status"]) == "0"): ?><span class="waits">已提交</span><?php endif; ?>
                        <?php if(($v["status"]) == "1"): ?><span class="saves">资料通过,等待人工电话确认</span><?php endif; ?>
                        <?php if(($v["status"]) == "2"): ?><span class="waits">资料审核未通过</span><?php endif; ?>
                        <?php if(($v["status"]) == "3"): ?><span class="saves">正在审核中</span><?php endif; ?>
                        <?php if(($v["status"]) == "4"): ?><span class="saves">已还款</span><?php endif; ?>
                        <?php if(($v["status"]) == "5"): ?><a href="javascript:doRespay('<?php echo ($v["sn"]); ?>');" class="respay-btn" style="font-size: 1.6rem">去还款</a><span class="success">已确认办理</span><?php endif; ?>
                        <?php if(($v["status"]) == "6"): ?><span class="saves">取消办理</span><?php endif; ?>
                        <?php if(($v["status"]) == "7"): ?><span class="saves"><font color=red>业务已逾期</font></span><a href="javascript:doRespay('<?php echo ($v["sn"]); ?>');" class="respay-btn" style="font-size: 1.6rem">去还款</a><?php endif; ?>
                    </p>
                </div>
        </div>
        ...
        function doRespay(data) {
        // var data = {ids: "<?php echo ($list["gids"]); ?>"};
        var data = {ids: data};
        showPreLoading();
        $.ajax({
            url: "<?php echo U('Index/plans_respay');?>", type: 'post',
