...
<div class="contentpanel">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<?php echo U('Fina/getDrawCode');?>" class="form-inline mb15" role="form">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="datatables">
                    ...
                    <?php if(is_array($list["list"])): $i = 0; $__LIST__ = $list["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($v["id"]); ?></td>
                             <td><?php echo ($v["drop_id"]); ?></td>
                            <!-- <td><?php echo ($v["sn"]); ?></td> -->
                            <td><?php echo ($v["sys_name"]); ?></td>
                            <td><?php echo ($v["money"]); ?></td>
                            <td><?php echo ($v["wc_sn"]); ?></td>
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.status !== 1) {
                            ...
                            window.location.href="<?php echo U('Backet/Doexc/Doexcel_draw_code');?>?start="+start+"&ends="+ends;
                        }
                    }
                });
                layer.close(index);
