...
<div class="contentpanel">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">返利费用列表</h3>
            <!--p>
                ...
                <table class="table table-bordered" id="datatables">
                    <thead>
                        <tr>
                            <th width="10%">#</th>
                            <th width="10%">级别名称</th>
                            <th width="10%">达标订单数量</th>
                            <th width="15%">上级代理返利</th>
                            <th width="15%">二级代理返利</th>
                            <th width="15%">三级代理返利</th>
                            <th width="15%">最低购买数量</th>
                            <th width="10%">级别状态</th>
                            <th width="20%">&nbsp;</th>
                        </tr>
                    </thead>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($v["months"]); ?>单</td>
                            <td><?php echo ($v["first"]); ?>元</td>
                            <td><?php echo ($v["second"]); ?>元</td>
                            <td><?php echo ($v["third"]); ?>元</td>
                            <td><?php echo ($v["buynum"]); ?>盒</td>
                            <td><?php echo ($v['status']>0?'使用中':'暂停'); ?></td>
                            <td>
                                <a href="<?php echo U('Membs/leveledit','id='.$v['id']);?>" class='btn btn-xs btn-info'>修改</a>
                            </td>
