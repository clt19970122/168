            ...
            <form action="<?php echo U('Fina/getDrawCode');?>" class="form-inline mb15" role="form">
                ...
                <!--<div class="form-group">
                    <select name="type" id="sssssssss" class="form-control input-sm">
                        ...
                        &lt;!&ndash;<option value="4">已取消</option>&ndash;&gt;
                    </select>
                </div>-->
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="datatables">
                    ...
                    <?php if(is_array($list["list"])): $i = 0; $__LIST__ = $list["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($v["id"]); ?></td>
                            <td><?php echo ($v["sn"]); ?></td>
                            <td><?php echo ($v["resn"]); ?></td>
                            <td><?php echo ($v["money"]); ?></td>
                            <td><?php echo ($v["time"]); ?></td>
                            <td><?php echo ($v["inway"]); ?></td>
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.status !== 1) {
                            ...
                            window.location.href="<?php echo U('Backet/Doexc/doExcel_money_in');?>?start="+start+"&ends="+ends;
                        }
                    }
                });
                layer.close(index);
