...
<div class="contentpanel">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="<?php echo U('Plansb/index','type='.$type.'&p='.$page);?>" class="form-inline mb15" role="form">
                ...
                <!-- <div class="btn btn-default btn-sm" id="doExcel2" style="padding-left: 20px;background-color: #2f27b2;color: white;">导出数据</div> -->
                  ...
                  $.ajax({
                      ...
                      success: function (res) {
                          if (res.status !== 1) {
                              ...
                              window.location.href="<?php echo U('Backet/Docsv/export_plan2');?>?sn="+sn+"&name="+name+"&phone="+phone+"&start="+start+"&ends="+ends+"&status="+status;
