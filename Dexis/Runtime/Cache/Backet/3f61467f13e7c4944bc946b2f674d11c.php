...
<div class="contentpanel">
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <p class="pd-l-20 tx-12 lh-8 mg-b-0">每日各个等级会员新增情况</p>
        </div>
                ...
                <div class="card shadow-base overflow-hidden">
                    ...
                    <div class="card-body pd-0 bd-color-gray-lighter">
                        <div class="row no-gutters tx-center">
                            <?php if(is_array($level)): $i = 0; $__LIST__ = $level;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Users/userLlCgList','level='.$vo['id']);?>">
                                    <div class="col-6 col-sm-2 pd-y-20 bd-l bd-color-gray-lighter" <?php if($get['level'] == $vo['id']): ?>style="color:red;font-size:20px"<?php endif; ?>>
                                        <h3 class="tx-inverse tx-lato tx-bold mg-b-5"><?php if($levelData[$vo['id']] != null): echo ($levelData[$vo['id']]); else: ?>0<?php endif; ?></h3>
                                        <p class="tx-12 mg-b-0"><?php echo ($vo["name"]); ?></p>
                                    </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<?php echo U('Users/userLlCgList','level='.$get['level']);?>" class="form-inline mb15" role="form">
                ...
                <div class="form-group">
                    <input type="text" name='start' class="form-control input-sm" id="single_start" value='<?php echo ($get["start"]); ?>' placeholder="请选择开始时间"/>
                </div>
                <div class="form-group">
                    <input type="text" name='ends' class="form-control input-sm" id="single_end" value='<?php echo ($get["ends"]); ?>' placeholder="请选择结束时间"/>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="datatables">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <!--<td><a href="javascript:showList('<?php echo ($v["uid"]); ?>');"><?php echo ($v["uname"]); ?></a></td>-->
