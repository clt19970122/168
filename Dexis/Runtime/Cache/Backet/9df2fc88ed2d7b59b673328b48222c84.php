            ...
            <form class="form">
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            <label>发布状态</label>
                            <textarea class="form-control" id="editor_id" rows="20" name="content" style="width:100%;"></textarea>
                        </div>
                    </div>
                </div>
            </form>
<!--             <hr style="border: 1px solid">
            <form action="<?php echo U('conte/addType');?>">
                <div class="form-group" >
                    <label class="col-sm-3 control-label">添加广告分类</label>
                    <div class="col-sm-5">
                        <input type="text" name="name"  class="form-control" />
                        <input type="submit" style="background-color: #527eb2" class="form-control"/>
                    </div>
                </div>
            </form> -->
        </div>
        <div class="panel-footer">
            <div class="row">
                <div class="col-sm-6">
                    <button class="btn btn-primary" onclick="onsubattr();">新增</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function onsubattr() {
        ...
        $.ajaxFileUpload({
            url: "<?php echo U('Core/addon', 'model=school');?>",
