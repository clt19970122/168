...
<div class="contentpanel">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="<?php echo U('Apply/index');?>" class="form-inline mb15" role="form">
                <div class="form-group">
                    <input type="text" name='sn' id="sn" class="form-control input-sm" value="<?php echo ($get["sn"]); ?>" placeholder="请输入订单编号"/>
                </div>
                <div class="form-group">
                    <input type="text" name='phone' id="phone" class="form-control input-sm" value="<?php echo ($get["phone"]); ?>" placeholder="请输入手机号码"/>
                </div>
                <div class="form-group">
                    <input type="text" name='start' class="form-control input-sm" value="<?php echo ($get["start"]); ?>" id="single_start" placeholder="请选择支付开始时间"/>
                </div>
                <div class="form-group">
                    <input type="text" name='ends' class="form-control input-sm" value="<?php echo ($get["ends"]); ?>" id="single_end" placeholder="请选择支付结束时间"/>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="datatables">
                    ...
                    <?php if(is_array($list["list"])): $i = 0; $__LIST__ = $list["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php echo ($v['status']==0?'已取消':''); ?>
                                <?php echo ($v['status']==1?'已查看':''); ?>
                                <?php echo ($v['status']==2?'已通过':''); ?>
                            </td>
...
<script>
    ...
    function pagereload() {
        ...
        var url = "<?php echo U('Apply/index');?>?p=" + page;
...
<script>
    $("#doExcel").on('click',function(){
        ...
        window.location.href="<?php echo U('Backet/Doexc/doExcel_apply');?>?sn="+sn+"&phone="+phone+"&start="+start+"&ends="+ends;
