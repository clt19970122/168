...
<div class="contentpanel">
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="datatables">
                    ...
                    <?php if(is_array($list["list"])): $i = 0; $__LIST__ = $list["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($v["id"]); ?></td>
                            <td><?php echo ($v['count']->name); ?></td>
                            <td><?php echo ($v['count']->phone); ?></td>
                            <td><?php echo ($v['count']->contact); ?></td>
                            <td><?php echo ($v['count']->age); ?></td>
                            <td><?php echo ($v['count']->sex); ?></td>
                            <td><?php echo ($v['count']->height); ?></td>
                            <td><?php echo ($v['count']->weight); ?></td>
                            <td><?php echo ($v['count']->job); ?></td>
                            <td><?php echo ($v['count']->breakfast); ?></td>
                            <td><?php  if(is_array($v['count']->stomach)){echo implode(',',$v['count']->stomach);}else{echo $v['count']->stomach;};?></td>
                            <td><?php  if(is_array($v['count']->problem)){echo implode(',',$v['count']->problem);}else{echo $v['count']->problem;};?></td>
                            <td><?php  if(is_array($v['count']->habit)){echo implode(',',$v['count']->habit);}else{echo $v['count']->habit;};?></td>
                            <td><?php  if(is_array($v['count']->taste)){echo implode(',',$v['count']->taste);}else{echo $v['count']->taste;};?></td>
                            <td><?php echo ($v['count']->diet); ?></td>
                            <td><?php echo ($v['count']->time); ?></td>
                            <td><?php echo ($v['count']->sport); ?></td>
                            <td><?php  if(is_array($v['count']->way)){echo implode(',',$v['count']->way);}else{echo $v['count']->way;};?></td>
                            <td><?php  if(is_array($v['count']->effectLose)){echo implode(',',$v['count']->effectLose);}else{echo $v['count']->effectLose;};?></td>
                            <td><?php echo ($v['count']->loseNum); ?></td>
                            <td><?php echo ($v['count']->howlong); ?></td>
   ...
   <script>
        $("#doExcel").on('click',function(){
            window.location.href="<?php echo U('Backet/Doexc/doExcel_weight');?>";
        });
    </script>
