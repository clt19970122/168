...
<div class="contentpanel">
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <p>
                <a href="<?php echo U('sale/stockAndSale');?>" class="btn btn-xs btn-info">添加内容</a>
                <span>tag:公司进货是从仓库入,总量不加</span>
            </p>
            <p>
                <a href="<?php echo U('sale/addOutCode');?>" class="btn btn-xs btn-info">增加出货记录</a>
            </p>
        </div>
        <div class="panel-body">
            <div class="row">
                        ...
                        <div class="panel-heading">
                            <div class="stat">
                                <div class="row">
                                    ...
                                    <div class="col-xs-8">
                                        <small class="stat-label">购进</small>
                                        <h1><?php echo ($data_info["all_in"]); ?></h1>
                                    </div>
                                </div><!-- row -->
                            </div><!-- stat -->
                        </div><!-- panel-heading -->
                        ...
                        <div class="panel-heading">
                            <div class="stat">
                                <div class="row">
                                    ...
                                    <div class="col-xs-8">
                                        <small class="stat-label">销售</small>
                                        <h1><?php echo ($data_info["all_sale"]); ?></h1>
                                    </div>
                                </div><!-- row -->
                            </div><!-- stat -->
                        </div><!-- panel-heading -->
                ...
                <!--存-->
                <div class="col-sm-6 col-md-3" id="saveNums">
                            ...
                            <div class="stat">
                                <div class="row">
                                    ...
                                    <div class="col-xs-8">
                                        ...
                                        <h2>剩余库存<!--<?php echo ($data_info["all_save"]); ?>--></h2>
                                    </div>
                                </div><!-- row -->
                            </div><!-- stat -->
                        </div><!-- panel-heading -->
                ...
                <!--报表-->
                <div class="col-sm-6 col-md-3" id="tableNums">
                    <div class="panel panel-primary panel-stat">
                        <div class="panel-heading">
                            <div class="stat">
                                <div class="row">
...
<script>
    ...
    $('#inNums').on('click',function (){
        window.location.href="<?php echo U('sale/salelist',array('type'=>2));?>";
    });
    $('#outNums').on('click',function(){
        window.location.href="<?php echo U('sale/salelist',array('type'=>1));?>";
    }) ;
    $('#saveNums').on('click',function(){
        window.location.href="<?php echo U('sale/salelist',array('type'=>3));?>";
    });
    $('#tableNums').on('click',function(){
        window.location.href="<?php echo U('sale/salelist',array('type'=>4));?>";
    })
