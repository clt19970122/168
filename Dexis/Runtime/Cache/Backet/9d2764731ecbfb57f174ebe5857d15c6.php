    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="<?php echo U('Goods/order','type='.$type.'&p='.$page);?>" class="form-inline mb15" role="form">
                ...
                <div class="form-group">
                    <input type="text" name='ends' class="form-control input-sm"value="<?php echo ($end); ?>" id="single_end" placeholder="请选择申请结束时间"/>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="datatables">
                    ...
                    <?php if(is_array($list["list"])): $i = 0; $__LIST__ = $list["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($v["c_status"]); ?></td>
                            <td><?php echo ($v["every_pay"]); ?></td>
                            <td><?php echo ($v["pay_count"]); ?>/<?php echo ($v["payway"]); ?>期</td>
                            <td>
                                <a href="<?php echo U('stages/pay',['id'=>$v['id'],'type'=>1]);?>" class='btn btn-xs btn-info'>详情</a>
                                <?php if($v["status"] == 0): ?><a href="javascript:dels(<?php echo ($v["id"]); ?>);" class='btn btn-xs btn-danger'>取消订单</a><?php endif; ?>
...
<script>
    ...
    function dels(id) {
        ...
        var configURL = "<?php echo U('stages/edit');?>";
