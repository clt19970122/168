                    ...
                    <form role="form" name="addItems">
                        <div class="form-group">
                            ...
                            <select name="models" class="form-control">
                                <option value="index_banner">头部背景图</option>
                                <option value="index_middle">商品列表上背景图</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>链接</label>
                            <input type="text" name="links" class="form-control" placeholder="请输入广告链接">
                        </div>
                        <div class="form-group">
                            <label>广告图</label>
                            <input type="file" name="file" id="file"/>
                        </div>
                        <button type="button" class="btn btn-info" onclick="adsLog();">新增</button>
                    </form>
                </div>
            </div>
        ...
        <div class="col-md-8">
            ...
            <table class="table mb30">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($v["id"]); ?></td>
                        <td>
                            <?php echo ($v['models']=='index_banner'?'头部背景图':''); ?>
                            <?php echo ($v['models']=='index_middle'?'商品列表上背景图':''); ?>
                        </td>
                        <td><img src="/Public/uploads/ads/<?php echo ($v["imgs"]); ?>" width="60"/></td>
                        <td><?php echo ($v["links"]); ?></td>
                        <td><?php echo (date('Y/m/d H:i:s',$v["times"])); ?></td>
                        <td><a href='javascript:dels(<?php echo ($v["id"]); ?>);' class='btn btn-xs btn-danger'>删除</a></td>
...
<script>
    ...
    function adsLog() {
        var configURL = "<?php echo U('Core/addon', 'model=sysads');?>";
