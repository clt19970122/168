...
<div class="contentpanel">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <p>
                <a href="<?php echo U('Conte/quesaddon');?>" class="btn btn-xs btn-info">添加内容</a>
            </p>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="datatables">
                    ...
                    <?php if(is_array($list["list"])): $i = 0; $__LIST__ = $list["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a href="<?php echo U('Conte/quesedits','id='.$v['id']);?>" class='btn btn-xs btn-info'>修改</a>
...
<script>
    ...
    function dels(id) {
        ...
        var configURL = "<?php echo U('Core/dels', 'model=question');?>";
        var data = {id: id};
        //
        $.ajax({
