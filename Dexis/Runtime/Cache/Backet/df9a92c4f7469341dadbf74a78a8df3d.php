    ...
    <body style="height: 100%">
        ...
        <section>
            ...
            <div class="mainpanel">
                ...
                <!--<link rel="stylesheet" type="text/css" href="/Public/backet/js/lencharts/css/bootstrap.min.css" />-->
<link rel="stylesheet" type="text/css" href="/Public/backet/js/lencharts/css/orgtree.css" />
<script type="text/javascript" src="/Public/backet/js/lencharts/js/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="/Public/backet/js/lencharts/js/jquery.lenchart.js"></script>
<style type="text/css">
    /*加减号样式*/
