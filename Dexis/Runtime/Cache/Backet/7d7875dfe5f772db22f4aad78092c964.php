    ...
    <body style="height: 100%">
        ...
        <section>
            ...
            <div class="mainpanel">
                ...
                <script charset="utf-8" src="/Public/libs/kindeditor/kindeditor.js"></script>
<script charset="utf-8" src="/Public/libs/kindeditor/lang/zh_CN.js"></script>
...
<div class="pageheader">
    ...
    <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo U('Conte/artlist');?>">皇家学院</a></li>
            ...
            <form class="form">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="type" class="form-control">
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $info['type']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <p class='mt10'><img src='/Public/uploads/school/<?php echo ($info["imgs"]); ?>' height="100"/></p>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="video" rows="5"><?php echo ($info["video"]); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="status" class="form-control">
                                    ...
                                    <option value="0" <?php if(($info["status"]) == "0"): ?>selected<?php endif; ?>>草稿</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="form-group">
                            <label>发布状态</label>
                            <textarea class="form-control" id="editor_id" rows="20" name="content" style="width:100%;"><?php echo (htmlspecialchars_decode($info["content"])); ?></textarea>
                        </div>
                    </div>
                </div>
            </form>
...
<script>
    ...
    function onsubattr() {
        ...
        $.ajaxFileUpload({
            url: "<?php echo U('Core/edits', 'model=school');?>",
            ...
            success: function (data) {
                ...
                window.location.href = "<?php echo U('Conte/artlist');?>";
            },
            error: function (data) {
                console.log(data);
            }
