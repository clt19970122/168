                    ...
                    <div class="panel-heading">
                        ...
                        <div class="stat">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <small class="stat-label">账户库存</small>
                                    <h1><?php echo ($summary["rest_nums"]); ?></h1>
                                </div>
                            </div><!-- row -->
                        </div><!-- stat -->
                    </div><!-- panel-heading -->
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="stat">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <small class="stat-label">销售量</small>
                                    <h1><?php echo ($summary["nums"]); ?></h1>
                                </div>
                            </div><!-- row -->
                        </div><!-- stat -->
                    </div><!-- panel-heading -->
                        ...
                        <div class="stat">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <h1><?php echo ($summary["salemoney"]); ?></h1>
                                </div>
                            </div><!-- row -->
                        </div><!-- stat -->
                    </div><!-- panel-heading -->
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="stat">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <small class="stat-label">利润</small>
                                    <h1><?php echo ($user["person"]); ?></h1>
                                </div>
                            </div><!-- row -->
                        </div><!-- stat -->
                    </div><!-- panel-heading -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            ...
            <h3 class="panel-title">
                明细
                <a href="<?php echo U('doexc/doExcel_user_info','id='.$id);?>" class="btn btn-primary btn-xs pull-right" target="_blank">导出</a>
            </h3>
        </div>
        <div class="panel-body">
            <form action="<?php echo U('Users/getlist','p='.$page);?>" class="form-inline mb15" role="form">
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="datatables">
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            <td><a href="javascript:getinfo('<?php echo ($v["sn"]); ?>');"><?php echo (getpaytype($v["order_type"])); ?>-<?php echo ($v["sn"]); ?></a></td>
                            <td><?php echo ($v["pick_goods"]); ?>-<?php echo ($v["money_do"]); ?></td>
                            <td><?php echo ($v["up_user"]); ?></td>
                            <td><?php echo (getUserLevel($v["up_level"])); ?></td>
                            <td ><?php echo ($v["in_name"]); ?></td>
                            <td ><?php echo ($v["change_nums"]); ?></td>
                            <td><?php echo ($v["after_nums"]); ?></td>
                            <td ><?php echo ($v["change_money"]); ?></td>
                            <td><?php echo ($v["reback_info"]); ?></td>
                            <td><?php echo ($v["after_money"]); ?></td>
            ...
            <?php echo ($pg1); ?>
            <div class="table-responsive">
                <span style="font-size: 25px;color: blue">提货/转让记录</span>
                <table class="table table-striped" id="111">
                    <thead>
                    <tr>
                        <th width="10%">订单号</th>
                        <th width="10%">出货人</th>
                    ...
                    <?php if(is_array($nums)): $i = 0; $__LIST__ = $nums;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            <td><a href="javascript:getinfo('<?php echo ($v["sn"]); ?>');"><?php echo ($v["sn"]); ?></a></td>
                            <td><?php echo ($v["out_name"]); ?></td>
                            <td><?php echo (getUserLevel($v["out_level"])); ?></td>
                            <td><?php echo ($v["in_name"]); ?></td>
                            <td><?php echo ($v["nums"]); ?></td>
                            <td><?php echo ($v["reback_infos"]); ?></td>
                            <td><?php echo ($v["after_nums"]); ?></td>
                            <td><?php echo (date('Y/m/d H:i:s',$v["times"])); ?></td>
                            <td><?php echo ($v["do"]); ?></td>
                            <td style="color: red;font-size: 20px"><?php echo ($v["dostatus"]); ?></td>
                            <?php if($v['status'] != 1): ?><td>
                                   <a href="<?php echo U('Goods/orderinfo','id='.$v['id']);?>" class='btn btn-xs btn-info'>取消回档</a>
                               </td><?php endif; ?>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                </table>
...
<a href="" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" >View Live Demo</a>
<!-- LARGE MODAL -->
   ...
   <!-- <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
            ...
            <div class="modal-body pd-20" id="popup_body">
                ...
                <div style="border-bottom:#cb938a 1px solid ;margin-top: 10px">出货人：</div>
                ...
                &lt;!&ndash;<h4 class=" lh-3 mg-b-20"><a href="" class="tx-inverse hover-primary">Why We Use Electoral College, Not Popular Vote</a></h4>&ndash;&gt;
                &lt;!&ndash;<p class="mg-b-5">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. </p >&ndash;&gt;
            </div>&lt;!&ndash; modal-body &ndash;&gt;
            <div class="modal-footer">
                &lt;!&ndash;<button type="button" class="btn btn-primary tx-size-xs">Save changes</button>&ndash;&gt;
