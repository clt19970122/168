...
//        $this->push["url"] = "";
        $this->push["url"] ='http://www.jacobhooychina.cn';
   ...
   /* private function judgeTemps() {
    ...
    private function judgeTemps() {
        ...
        switch ($type){
            ...
            case 'failed':
                ...
                break;
            case 'reBackMess':
                $this->push["template_id"] = "_NPBHNmuq-aN6YZt_GP3uAAkHBKYI1urKKFKwV7OTJQ";
                return $this->reBackMess();
                break;
            case 'PayForUser':
                $this->push["template_id"] = "ieNU2cix5FBWFcsR3vzUph-WYUow-OFI_BAknfhcoY0";
                return $this->PayForUser();
                break;
            case 'notick':
                $this->push["template_id"] = "xqK-87pBrMkdQgJHiBCxjvIryi--ioR4EJusIyTtTqs";
                return $this->notick();
                break;
            case 'reback':
     ...
     * @return boolean
     */
    private function reBackMess() {

//        $this->push["url"] ='http://www.jacobhooychina.cn';
        $this->push["data"]["first"] = array("value" => "‘0元计划’还款提醒", "color" => "#2da94c");
        $this->push["data"]["keyword1"] = array("value" => $this->data["money"], "color" => "#2da94c");
        $this->push["data"]["keyword2"] = array("value" => $this->data["time"] , "color" => "#2da94c");
        $this->push["data"]["remark"] = array("value" => "请进入系统到'我的'->'0元计划记录’查看详情", "color" => "#2da94c");
        return $this->sentTempMsg();
    }
    /**
     * 账户激活--打款账户到账
     * @return boolean
     */
    private function PayForUser() {
        $this->push["data"]["first"] = array("value" => "系统提现打款到零钱到账提醒", "color" => "#2da94c");
        $this->push["data"]["keyword1"] = array("value" => $this->data["money"], "color" => "#2da94c");
        $this->push["data"]["keyword2"] = array("value" => $this->data["time"] , "color" => "#2da94c");
        $this->push["data"]["keyword3"] = array("value" => $this->data["intype"] , "color" => "#2da94c");
        $this->push["data"]["keyword4"] = array("value" => $this->data["info"] , "color" => "#2da94c");
        $this->push["data"]["keyword5"] = array("value" => $this->data["sn"] , "color" => "#2da94c");
        $this->push["data"]["remark"] = array("value" => "零钱到账", "color" => "#2da94c");
        return $this->sentTempMsg();
    }
    /**
     * 账户激活--通知用户
     * @return boolean
     */
    private function notick() {
        $this->push["data"]["first"] = array("value" => $this->data["head"], "color" => "#FF0000");
        $this->push["data"]["keyword1"] = array("value" => $this->data["time"], "color" => "#2da94c");
        $this->push["data"]["keyword2"] = array("value" => $this->data["types"] , "color" => "#2da94c");
        $this->push["data"]["keyword3"] = array("value" => $this->data["content"] , "color" => "#2da94c");
