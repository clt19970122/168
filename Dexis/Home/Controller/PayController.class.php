            ...
            if($draw_info){
                ...
                if ($pay_res['return_code'] == 'SUCCESS' && $pay_res['result_code'] == 'SUCCESS') {
                    ...
                    if ($res_data) {
                        ...
                        return get_op_put(1, '打款成功',U('Fina/index'));
                    }
                }else {
                    $add=[
                        'uid'=>$draw_info['usid'],
                        ...
                        'type'=>$get['type'],
                        'money'=>$draw_info['money'],
                        'msg'=>$pay_res['return_msg'].$pay_res['err_code_des'],
                        'time'=>time(),
                    ];
                    $draw_code->add($add);
                    $msg ='打款失败' .$pay_res['return_msg']. $pay_res['err_code_des'];
...
//        $params["mchid"] =C("WEC_CONFIG.MCHID");
        ...
        $params["desc"]=$desc.'信息-'.$openid;//企业付款备注
